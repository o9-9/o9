...
if ((Get-Item ".\o9.ps1" -ErrorAction SilentlyContinue).IsReadOnly) {
    Remove-Item ".\o9.ps1" -Force
}
...
Update-Progress -Activity "Validating" -StatusMessage "Checking o9.ps1 Syntax" -Percent 0
try {
    Get-Command -Syntax .\o9.ps1 | Out-Null
} catch {
    Write-Warning "Syntax Validation for 'o9.ps1' has failed"
