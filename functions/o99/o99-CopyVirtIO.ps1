function o99-CopyVirtIO {
    <#
        .SYNOPSIS
            Downloads and copies the VirtIO Guest Tools drivers to the target o99 ISO
        .NOTES
    ...
    try {
        ...
        if (Test-Path -Path "$($env:TEMP)\virtio.iso" -PathType Leaf) {
            ...
            Write-Host "To proceed with installation of the o99 image in QEMU/Proxmox VE:"
