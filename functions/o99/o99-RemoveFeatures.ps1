    ...
    try {
        if ($UseCmdlets) {
            ...
            if ($?) {
                ...
                Write-Host "Features could not be obtained with DISM. o99 processing will continue, but features will be skipped."
                return
            }
        }
        ...
        o99-RemoveFeatures -UseCmdlets $false
    }
}
