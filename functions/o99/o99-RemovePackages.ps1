    ...
    try {
        if ($useCmdlets) {
            ...
            if ($?) {
                ...
                Write-Host "Packages could not be obtained with DISM. o99 processing will continue, but packages will be skipped."
                return
            }
        }
        ...
        o99-RemovePackages -UseCmdlets $false
    }
}
