function Invoke-o9FeatureInstall {
    <#
    ...
    $CheckBox | ForEach-Object {
            ...
            Foreach( $feature in $sync.configs.feature.$psitem.feature ) {
                try {
                    ...
                    if ($psitem.Exception.Message -like "*requires elevation*") {
                        ...
                        $sync.form.Dispatcher.Invoke([action]{ Set-o9Taskbaritem -state "Error" })
                    } else {
        ...
        $X++
        $sync.form.Dispatcher.Invoke([action]{ Set-o9Taskbaritem -value ($x/$CheckBox.Count) })
    }
}
