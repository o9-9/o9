function Invoke-o9InstallPSProfile {
    <#
    .SYNOPSIS
        Backs up your original profile then installs and applies the o9 PowerShell profile.
    #>
    ...
    Invoke-WPFRunspace -ArgumentList $PROFILE -DebugPreference $DebugPreference -ScriptBlock {
        ...
        function Invoke-PSSetup {
            # Define the URL used to download o9 Tech's PowerShell profile.
            ...
            # Download o9 Tech's PowerShell profile to the 'TEMP' folder.
            Invoke-RestMethod $url -OutFile "$env:TEMP/Microsoft.PowerShell_profile.ps1"

            # Get the file hash for o9 Tech's PowerShell profile.
            $NewHash = Get-FileHash "$env:TEMP/Microsoft.PowerShell_profile.ps1"

            # Store the file hash of o9 Tech's PowerShell profile.
            ...
            if ($NewHash.Hash -ne $OldHash.Hash) {
                ...
                # Let the user know o9 Tech's PowerShell profile is being installed.
                ...
                Start-Process -FilePath "pwsh" -ArgumentList "-ExecutionPolicy Bypass -NoProfile -Command `"Invoke-Expression (Invoke-WebRequest `'https://github.com/o9-9/powershell-profile/raw/main/setup.ps1`')`"" -WindowStyle Hidden -Wait

                # Let the user know o9 Tech's PowerShell profile has been installed successfully.
                Write-Host "Profile has been installed. Please restart your shell to reflect the changes!" -ForegroundColor Magenta

                # Let the user know o9 Tech's PowerShell profile has been setup successfully.
                Write-Host "===> Finished Profile Setup <===" -ForegroundColor Yellow
            } else {
                # Let the user know o9 Tech's PowerShell profile is already fully up-to-date.
        ...
        if (Get-Command "pwsh" -ErrorAction SilentlyContinue) {
            ...
            if ($PSVersionTable.PSVersion.Major -ge 7) {
                # Invoke the PowerShell Profile setup script to install o9 Tech's PowerShell Profile.
                Invoke-PSSetup
            } else {
