function Invoke-o9ThemeChange {
    ...
    .EXAMPLE
        Invoke-o9ThemeChange
        # Toggles the theme between 'Light' and 'Dark'.

    .EXAMPLE
        Invoke-o9ThemeChange -init
    ...
    $LightPreferencePath = "$env:LOCALAPPDATA\o9\LightTheme.ini"
    $DarkPreferencePath = "$env:LOCALAPPDATA\o9\DarkTheme.ini"

    if ($init) {
        Set-o9Theme -currentTheme "shared"
    ...
    switch ($theme) {
        "Auto" {
            $systemUsesDarkMode = Get-o9ToggleStatus WPFToggleDarkMode
            if ($systemUsesDarkMode) {
                Set-o9Theme  -currentTheme "Dark"
            }
            else{
                Set-o9Theme  -currentTheme "Light"
            }
        ...
        "Dark" {
            Set-o9Theme  -currentTheme $theme
