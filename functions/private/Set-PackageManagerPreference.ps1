function Set-PackageManagerPreference {
    ...
    .SYNOPSIS
        ...
        Also persists preference across o9 restarts via preference.ini.
    ...
    $preferencePath = "$env:LOCALAPPDATA\o9\preferences.ini"
    $oldChocoPath = "$env:LOCALAPPDATA\o9\preferChocolatey.ini"
