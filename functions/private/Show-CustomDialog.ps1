function Show-CustomDialog {
    ...
    .PARAMETER LogoColor
    The Color of o9 Text found next to o9's Logo inside dialog window.
    ...
    $stackPanel.Children.Add((Invoke-o9Assets -Type "logo" -Size $LogoSize))

    # Add "o9" text
    $o9TextBlock = New-Object Windows.Controls.TextBlock
    $o9TextBlock.Text = "o9"
    $o9TextBlock.FontSize = $HeaderFontSize
    $o9TextBlock.Foreground = $LogoColor
    $o9TextBlock.Margin = New-Object Windows.Thickness(10, 10, 10, 5)  # Add margins around the text block
    $stackPanel.Children.Add($o9TextBlock)
