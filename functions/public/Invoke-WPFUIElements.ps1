function Invoke-WPFUIElements {
    <#
    .SYNOPSIS
        Adds UI elements to a specified Grid in the o9 GUI based on a JSON configuration.
            ...
            foreach ($entryInfo in $entries) {
                ...
                switch ($entryInfo.Type) {
                    "Toggle" {
                        ...
                        $sync[$entryInfo.Name].IsChecked = (Get-o9ToggleStatus $entryInfo.Name)

                        $sync[$entryInfo.Name].Add_Checked({
                            [System.Object]$Sender = $args[0]
                            Invoke-o9Tweaks $sender.name
                        })

                        $sync[$entryInfo.Name].Add_Unchecked({
                            [System.Object]$Sender = $args[0]
                            Invoke-o9tweaks $sender.name -undo $true
                        })
                    }
