...
$functions = Get-ChildItem function:\ | Where-Object { $_.Name -imatch 'o9|o99|WPF' }
...
if (-NOT ($readerOperationSuccessful)) {
    ...
    Write-Host "Quitting o9..." -ForegroundColor Red
...
# Setup the Window to follow listen for windows Theme Change events and update the o9 theme
    ...
    $hwndSource.AddHook({
        ...
        if (($msg -eq 0x001A) -and $sync.ThemeButton.Content -eq [char]0xF08C) {
            ...
            if ($currentTime - $lastThemeChangeTime -gt $debounceInterval) {
                Invoke-o9ThemeChange -theme "Auto"
...
Invoke-o9ThemeChange -init $true
...
# Progress bar in taskbaritem > Set-o9Progressbar
...
$commonKeyEvents = {
    ...
    if ($_.KeyboardDevice.Modifiers -eq "Alt") {
        ...
        switch ($_.SystemKey) {
            ...
            "M" { Invoke-WPFButton "WPFTab5BT"; $keyEventArgs.Handled = $true } # Navigate to o99 tab
        }
    }
...
$NavLogoPanel.Children.Add((Invoke-o9Assets -Type "logo" -Size 25)) | Out-Null

# Initialize the hashtable
$o9dir = @{}

# Set the path for the o9 directory
...
if (Test-Path $o9dir["logo.ico"]) {
    ...
    $sync["logorender"] = (Invoke-o9Assets -Type "Logo" -Size 90 -Render)
}
$sync["checkmarkrender"] = (Invoke-o9Assets -Type "checkmark" -Size 512 -Render)
$sync["warningrender"] = (Invoke-o9Assets -Type "warning" -Size 512 -Render)
...
$sync["DarkThemeMenuItem"].Add_Click({
    ...
    Invoke-WPFPopup -Action "Hide" -Popups @("Theme")
    Invoke-o9ThemeChange -theme "Dark"
})
$sync["LightThemeMenuItem"].Add_Click({
    Write-Debug "Light Theme clicked"
    Invoke-WPFPopup -Action "Hide" -Popups @("Theme")
    Invoke-o9ThemeChange -theme "Light"
})
...
$sync["SponsorMenuItem"].Add_Click({
    ...
    $authorInfo = @"
<a href="https://github.com/sponsors/o9-9">Current sponsors for o9-9:</a>
"@
    $authorInfo += "`n"
    try {
        $sponsors = Invoke-o9Sponsors
        foreach ($sponsor in $sponsors) {
            $authorInfo += "<a href=`"https://github.com/sponsors/o9-9`">$sponsor</a>`n"
        }
    } catch {
